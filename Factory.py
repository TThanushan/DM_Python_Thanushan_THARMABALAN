...
class Task:
    ...
    def run(self):
        ...
        print(
            self.name
            + " : Starting task ("
            + self.last_execution_time.strftime("%H:%M:%S")
            + ") : execution time = "
        ...
        while 1:
            ...
            if (self.name == "pump 1" or self.name == "pump 2") and tank == 50:
                ...
                return
            elif (self.name == "pump 1" and tank + 10 > 50) or (
                self.name == "pump 2" and tank + 20 > 50
            ):
                print(
                    " reservoir du pump bloqué car l'ajout d'huile impliquera un excés de stockage"
                )
                return
            ...
            if self.name == "machine 1" and tank >= 25:
                if stock1 % 4 >= stock2:
                    print(
                        "machine 1 bloquée car la fabrication de moteur est prioritaire"
                    )
                    return
                else:
                    stock1 += 1
            ...
            if self.name == "machine 2" and tank >= 5:
                if stock1 % 4 < stock2:
                    print(
                        "machine 2 bloquée car la fabrication de roues est prioritaire"
                    )
                    return
                else:
                    stock2 += 1
